...
getScreenDevices();
	...
	public BufferedImage createScreenCapture(Rectangle bounds) {
		int[] pixels= getRGBPixels(bounds);
		ColorModel model = new DirectColorModel(32, 0xff0000, 0xff00, 0xff, 0xff000000);
		BufferedImage image = new BufferedImage(model, Raster.createWritableRaster(model.createCompatibleSampleModel(bounds.width, bounds.height), new DataBufferInt(pixels, bounds.width * bounds.height), null), false, new Hashtable<Object, Object>());
		return image;
	}
